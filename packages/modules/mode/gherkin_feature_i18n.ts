...
// @ts-nocheck
import { getGherkinDialect } from '../dialects/gherkin_feature_i18n'
import escapeStringRegexp from 'escape-string-regexp'
import { define } from 'ace-builds'

define('ace/mode/gherkin_feature_highlight_rules', [
  'require',
  'exports',
  'module',
  'ace/lib/oop',
...
define('ace/mode/gherkin_feature_i18n', [
  'require',
  'exports',
  'module',
  'ace/lib/oop',
  'ace/mode/text',
  'ace/mode/gherkin_feature_highlight_rules'
], function (acequire, exports, module) {
  const oop = acequire('../lib/oop')
  const TextMode = acequire('./text').Mode
  const GherkinHighlightRules = acequire('./gherkin_feature_highlight_rules')
  ...
  ;(function () {
    ...
    this.$id = 'ace/mode/gherkin_feature_i18n'
